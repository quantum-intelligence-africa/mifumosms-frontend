...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      {/* Mobile Menu Overlay - Deel-style Enterprise Design */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: isMobileMenuOpen ? 1 : 0 }}
        transition={{ duration: 0.2 }}
        className={`fixed inset-0 z-[1000] lg:hidden ${isMobileMenuOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}
      >
        {/* Backdrop */}
        <div 
        ...
        <motion.div
          ...
          className="absolute top-0 left-0 right-0 h-screen bg-white flex flex-col overflow-hidden"
        >
          {/* Fixed Header - Same style as main header */}
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <nav className="px-4 py-6">
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-between py-5 border-b border-gray-100 group touch-manipulation"
              >
          ...
          <motion.div
            ...
            className="px-4 py-6 bg-white border-t border-gray-100 space-y-3"
          >
            {/* Primary CTA - Get Started */}
            <Link to="/signup" onClick={() => setIsMobileMenuOpen(false)} className="block">
              <motion.button
                whileTap={{ scale: 0.98 }}
                className="w-full h-14 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-base rounded-full shadow-lg shadow-blue-600/25 transition-all duration-200 touch-manipulation flex items-center justify-center"
              >
                Get Started
              </motion.button>
            </Link>
            ...
            >
              <motion.button
                whileTap={{ scale: 0.98 }}
                className="w-full h-14 bg-white hover:bg-gray-50 text-gray-700 font-semibold text-base rounded-full border-2 border-gray-200 transition-all duration-200 touch-manipulation flex items-center justify-center gap-3"
              >
