...
const PertinaInsights = () => {
  ...
  // Check if user is Partina - redirect if not
  if (!isPartina()) {
    return (
      <div className="min-h-screen bg-gradient-surface flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-text-subtle mb-6">Partina Insights is exclusively available for approved Mifumo Connect Partners (Partina).</p>
          <div className="bg-surface rounded-lg p-4 text-left mb-6">
            ...
            <ol className="text-sm text-text-subtle space-y-2 list-decimal list-inside">
              ...
              <li>Once approved, return to access Partina Insights</li>
            </ol>
          </div>
